### Truncated Normal Distribution implementation taken from Anton Obukhov at https://github.com/toshas/torch_truncnorm/blob/main/TruncatedNormal.py Full credits to him.
import math
