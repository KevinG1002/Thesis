...
def run(cfg: CONFIG):
    ...
    diffusion_sampler = DDPMSampler(diffusion_process, sample_channels=cfg.sample_channels, sample_size = cfg.sample_size, device = cfg.device, checkpoint_dir=cfg.checkpoint_path)
